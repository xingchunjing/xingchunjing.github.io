import{_ as a,X as n,Y as s,a4 as e}from"./framework-a5b3b151.js";const p={},l=e(`<h2 id="查看大文件" tabindex="-1"><a class="header-anchor" href="#查看大文件" aria-hidden="true">#</a> 查看大文件</h2><h3 id="ls" tabindex="-1"><a class="header-anchor" href="#ls" aria-hidden="true">#</a> ls</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#最简单的方法就是借助 ls 命令，因为 ls 命令本身输出是带文件大小信息的。</span>
...
<span class="token parameter variable">-S</span> 显示目录的大小，但不含子目录大小</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11),t=[l];function i(r,c){return n(),s("div",null,t)}const d=a(p,[["render",i],["__file","fdir.html.vue"]]);export{d as default};
