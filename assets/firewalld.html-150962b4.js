import{_ as a,X as e,Y as s,a2 as n}from"./framework-f01f539c.js";const i={},l=n(`<h2 id="firewalld的基本使用" tabindex="-1"><a class="header-anchor" href="#firewalld的基本使用" aria-hidden="true">#</a> firewalld的基本使用</h2><p>启动：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>systemctl start firewalld
