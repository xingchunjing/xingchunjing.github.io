import{_ as a,X as n,Y as s,a5 as e}from"./framework-608b3dd6.js";const p={},l=e(`<h2 id="查看大文件" tabindex="-1"><a class="header-anchor" href="#查看大文件" aria-hidden="true">#</a> 查看大文件</h2><h3 id="ls" tabindex="-1"><a class="header-anchor" href="#ls" aria-hidden="true">#</a> ls</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#最简单的方法就是借助 ls 命令，因为 ls 命令本身输出是带文件大小信息的。</span>
