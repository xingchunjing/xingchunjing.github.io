import{_ as c,X as o,Y as l,Z as n,$ as s,a0 as a,a1 as i,a4 as u,E as e}from"./framework-a5b3b151.js";const k="/assets/images/rediscache01.jpg",r={},d=n("h1",{id:"缓存配置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#缓存配置","aria-hidden":"true"},"#"),s(" 缓存配置")],-1),v=u(`<h2 id="添加redis依赖包" tabindex="-1"><a class="header-anchor" href="#添加redis依赖包" aria-hidden="true">#</a> 添加Redis依赖包</h2><p>在项目的pom.xml中添加如下：</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code><span class="token comment">&lt;!-- redis依赖包 ,版本是和项目的Spring Boot版本一至--&gt;</span>
