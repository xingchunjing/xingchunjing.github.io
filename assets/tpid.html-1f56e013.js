import{_ as a,X as s,Y as n,a5 as e}from"./framework-608b3dd6.js";const i={},d=e(`<h2 id="线程命令" tabindex="-1"><a class="header-anchor" href="#线程命令" aria-hidden="true">#</a> 线程命令</h2><h3 id="根据pid查看进程" tabindex="-1"><a class="header-anchor" href="#根据pid查看进程" aria-hidden="true">#</a> 根据pid查看进程</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#ps查询</span>
