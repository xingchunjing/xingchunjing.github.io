import{_ as a,X as n,Y as s,a2 as e}from"./framework-f01f539c.js";const p={},i=e(`<h2 id="linux命令" tabindex="-1"><a class="header-anchor" href="#linux命令" aria-hidden="true">#</a> linux命令</h2><h3 id="根据pid查看进程" tabindex="-1"><a class="header-anchor" href="#根据pid查看进程" aria-hidden="true">#</a> 根据pid查看进程</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#ps查询</span>
